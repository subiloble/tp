...
public class JsonAdaptedPersonTest {
    ...
    private static final List<JsonAdaptedSubjects> VALID_TAGS = BENSON.getSubjects().stream()
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE, VALID_EMAIL, VALID_TAGS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        List<JsonAdaptedSubjects> invalidTags = new ArrayList<>(VALID_TAGS);
        invalidTags.add(new JsonAdaptedSubjects(INVALID_TAG));
        JsonAdaptedPerson person =
