...
1. **Verify the setup**:
   1. Run the `seedu.mentorstack.Main` and try a few commands.
...
1. **Learn the design**
   ...
   When you are ready to start coding, we recommend that you get some sense of the overall design by reading about [Mentorstack’s architecture](DeveloperGuide.md#architecture).
